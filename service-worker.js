const CACHE='seoul-travel-v1.15';
const ASSETS=['./','./index.html','./styles.css?v=1.15','./app.js?v=1.15','./manifest.webmanifest?v=1.15','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
