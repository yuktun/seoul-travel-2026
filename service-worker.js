const CACHE='seoul-travel-v1.16';
const ASSETS=['./','./index.html','./styles.css?v=1.16','./app.js?v=1.16','./manifest.webmanifest?v=1.16','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
