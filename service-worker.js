const CACHE='seoul-travel-v1.47';
const ASSETS=['./','./index.html','./styles.css?v=1.47','./app.js?v=1.47','./manifest.webmanifest?v=1.47','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
