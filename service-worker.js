const CACHE='seoul-travel-v1.31';
const ASSETS=['./','./index.html','./styles.css?v=1.31','./app.js?v=1.31','./manifest.webmanifest?v=1.31','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
