const CACHE='seoul-travel-v1.19';
const ASSETS=['./','./index.html','./styles.css?v=1.19','./app.js?v=1.19','./manifest.webmanifest?v=1.19','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
