const CACHE='seoul-travel-v1.41';
const ASSETS=['./','./index.html','./styles.css?v=1.41','./app.js?v=1.41','./manifest.webmanifest?v=1.41','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
