const CACHE='seoul-travel-v1.38';
const ASSETS=['./','./index.html','./styles.css?v=1.38','./app.js?v=1.38','./manifest.webmanifest?v=1.38','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
