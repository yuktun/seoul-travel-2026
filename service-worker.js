const CACHE='seoul-travel-v1.36';
const ASSETS=['./','./index.html','./styles.css?v=1.36','./app.js?v=1.36','./manifest.webmanifest?v=1.36','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
