const CACHE='seoul-travel-v1.12';
const ASSETS=['./','./index.html','./styles.css?v=1.12','./app.js?v=1.12','./manifest.webmanifest?v=1.12','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
