const CACHE='seoul-travel-v1.22';
const ASSETS=['./','./index.html','./styles.css?v=1.22','./app.js?v=1.22','./manifest.webmanifest?v=1.22','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
