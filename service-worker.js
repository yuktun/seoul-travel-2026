const CACHE='seoul-travel-v1.23';
const ASSETS=['./','./index.html','./styles.css?v=1.23','./app.js?v=1.23','./manifest.webmanifest?v=1.23','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
