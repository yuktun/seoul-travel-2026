const CACHE='seoul-travel-v1.54';
const ASSETS=['./','./index.html','./styles.css?v=1.54','./app.js?v=1.54','./manifest.webmanifest?v=1.54','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
