const CACHE='seoul-travel-v1.21';
const ASSETS=['./','./index.html','./styles.css?v=1.21','./app.js?v=1.21','./manifest.webmanifest?v=1.21','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
