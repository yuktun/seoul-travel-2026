const CACHE='seoul-travel-v1.11';
const ASSETS=['./','./index.html','./styles.css?v=1.11','./app.js?v=1.11','./manifest.webmanifest?v=1.11','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
