const CACHE='seoul-travel-v1.29';
const ASSETS=['./','./index.html','./styles.css?v=1.29','./app.js?v=1.29','./manifest.webmanifest?v=1.29','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
