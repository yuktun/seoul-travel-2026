const CACHE='seoul-travel-v1.26';
const ASSETS=['./','./index.html','./styles.css?v=1.26','./app.js?v=1.26','./manifest.webmanifest?v=1.26','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
