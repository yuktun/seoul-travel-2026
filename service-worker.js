const CACHE='seoul-travel-v1.27';
const ASSETS=['./','./index.html','./styles.css?v=1.27','./app.js?v=1.27','./manifest.webmanifest?v=1.27','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
