const CACHE='seoul-travel-v1.32';
const ASSETS=['./','./index.html','./styles.css?v=1.32','./app.js?v=1.32','./manifest.webmanifest?v=1.32','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
