const CACHE='seoul-travel-v1.37';
const ASSETS=['./','./index.html','./styles.css?v=1.37','./app.js?v=1.37','./manifest.webmanifest?v=1.37','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
