const CACHE='seoul-travel-v1.20';
const ASSETS=['./','./index.html','./styles.css?v=1.20','./app.js?v=1.20','./manifest.webmanifest?v=1.20','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
