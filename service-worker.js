const CACHE='seoul-travel-v1.13';
const ASSETS=['./','./index.html','./styles.css?v=1.13','./app.js?v=1.13','./manifest.webmanifest?v=1.13','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
