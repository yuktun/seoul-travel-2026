const CACHE='seoul-travel-v1.24';
const ASSETS=['./','./index.html','./styles.css?v=1.24','./app.js?v=1.24','./manifest.webmanifest?v=1.24','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
