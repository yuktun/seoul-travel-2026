const CACHE='seoul-travel-v1.10';
const ASSETS=['./','./index.html','./styles.css?v=1.10','./app.js?v=1.10','./manifest.webmanifest?v=1.10','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
