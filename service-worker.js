const CACHE='seoul-travel-v1.30';
const ASSETS=['./','./index.html','./styles.css?v=1.30','./app.js?v=1.30','./manifest.webmanifest?v=1.30','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
