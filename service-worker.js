const CACHE='seoul-travel-v1.25';
const ASSETS=['./','./index.html','./styles.css?v=1.25','./app.js?v=1.25','./manifest.webmanifest?v=1.25','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
