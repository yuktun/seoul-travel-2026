const CACHE='seoul-travel-v1.33';
const ASSETS=['./','./index.html','./styles.css?v=1.33','./app.js?v=1.33','./manifest.webmanifest?v=1.33','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
