const CACHE='seoul-travel-v1.53';
const ASSETS=['./','./index.html','./styles.css?v=1.53','./app.js?v=1.53','./manifest.webmanifest?v=1.53','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
const FIREBASE_SDK=[
